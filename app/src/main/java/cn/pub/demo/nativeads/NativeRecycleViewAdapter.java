...
public class NativeRecycleViewAdapter extends RecyclerView.Adapter {
    ...
    private static final int ITEM_VIEW_TYPE_PUB = 6;

    private List<PubCustomNativeAd> mData;
    private Context context;


    public NativeRecycleViewAdapter(Context context, List<PubCustomNativeAd> mData) {
        this.mData = mData;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder instanceof NormalViewHolder) {
            ...
            PubCustomNativeAd pubCustomNativeAd = mData.get(i);
            ViewGroup adCardView = (ViewGroup) adViewHolder.itemView;
            adCardView.removeAllViews();
            pubCustomNativeAd.showAd(adCardView, R.layout.tp_native_ad_list_item, "");
        }
    }
    ...
    public int getItemViewType(int position) {
        if (mData != null) {
            PubCustomNativeAd ad = mData.get(position);
            if (ad == null) {
                return ITEM_VIEW_TYPE_NORMAL;
            } else {
                return ITEM_VIEW_TYPE_PUB;
            }
    ...
    private class AdViewHolder extends RecyclerView.ViewHolder {
        ...
        public AdViewHolder(View itemView) {
            ...
            pubView = itemView.findViewById(R.id.tpview);
        }
    }
